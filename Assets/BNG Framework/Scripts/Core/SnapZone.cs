...
namespace BNG
{
    public class SnapZone : MonoBehaviour
    {
        ...
        void disableGrabbable(Grabbable grab)
        {
            ...
            if (DisableColliders)
            {
                disabledColliders = GetCollidersInChilden(grab.transform, new List<Collider>());
        ...
        private List<Collider> GetCollidersInChilden(Transform parent, List<Collider> colliders)
        {
            ...
            if (collider != null)
            {
                ...
                if (collider.GetComponent<SnapZone>() == null)
                {
                    ...
                    {
                        GetCollidersInChilden(child, colliders);
                    }
                }
            }
